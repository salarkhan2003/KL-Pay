...
const TULIP_SNACKS  = 'tulip-snacks';
const HIM_CANTEEN   = 'himalaya-canteen';
const HIM_JUICE     = 'himalaya-juice';
const KG_CANTEEN    = 'kg-canteen';
const KG_SNACKS     = 'kg-snacks';
...
const SEED_OUTLETS = [
  ...
  { id: TULIP_SNACKS, name: 'Tulip Snacks Corner', description: 'Quick bites and evening snacks.',           image_url: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&w=400',  is_open: true, merchant_id: '', block_name: 'Tulip Hostel',         category: 'Snacks', upi_id: 'tulip.snacks@okaxis',     timings: '4pm – 10pm', rating: 4.3 },
  { id: HIM_CANTEEN,  name: 'Himalaya Canteen',    description: 'Full meals and daily specials.',            image_url: 'https://images.unsplash.com/photo-1567529684892-09290a1b2d05?auto=format&fit=crop&w=400',  is_open: true, merchant_id: '', block_name: 'Himalaya Hostel',      category: 'Meals',  upi_id: 'himalaya.canteen@okaxis', timings: '7am – 9pm',  rating: 4.5 },
  { id: HIM_JUICE,    name: 'Himalaya Juice Bar',  description: 'Fresh juices and smoothies.',               image_url: 'https://images.unsplash.com/photo-1600271886742-f049cd451bba?auto=format&fit=crop&w=400',  is_open: true, merchant_id: '', block_name: 'Himalaya Hostel',      category: 'Juice',  upi_id: 'himalaya.juice@okaxis',   timings: '8am – 8pm',  rating: 4.6 },
  { id: KG_CANTEEN,   name: 'KG Canteen',          description: 'Home-style meals for KG residents.',        image_url: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&w=400',     is_open: true, merchant_id: '', block_name: 'Kanchan Ganga Hostel', category: 'Meals',  upi_id: 'kg.canteen@okaxis',       timings: '7am – 9pm',  rating: 4.4 },
  { id: KG_SNACKS,    name: 'KG Snacks',           description: 'Evening snacks and chai.',                  image_url: 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?auto=format&fit=crop&w=400',    is_open: true, merchant_id: '', block_name: 'Kanchan Ganga Hostel', category: 'Snacks', upi_id: 'kg.snacks@okaxis',        timings: '3pm – 9pm',  rating: 4.2 },
...
const SEED_MENU = [
  ...
  { id: `${FRIENDS_ID}_egg_rice`,   outlet_id: FRIENDS_ID,   name: 'Egg Fried Rice',   description: 'Wok-tossed egg fried rice',                     price: 60,  image_url: 'https://images.unsplash.com/photo-1603133872878-684f208fb84b?auto=format&fit=crop&w=400',  category: 'Main',     is_available: true, prep_time: '10m' },
  { id: `${FRIENDS_ID}_chai`,       outlet_id: FRIENDS_ID,   name: 'Masala Chai',      description: 'Hot spiced tea',                                price: 10,  image_url: 'https://images.unsplash.com/photo-1556679343-c7306c1976bc?auto=format&fit=crop&w=400',  category: 'Beverage', is_available: true, prep_time: '5m'  },
  { id: `${TULIP_SNACKS}_samosa`,   outlet_id: TULIP_SNACKS, name: 'Samosa',           description: 'Crispy fried samosa with chutney',              price: 15,  image_url: 'https://images.unsplash.com/photo-1601050690597-df0568f70950?auto=format&fit=crop&w=400', category: 'Snack',    is_available: true, prep_time: '5m'  },
  { id: `${TULIP_SNACKS}_maggi`,    outlet_id: TULIP_SNACKS, name: 'Maggi',            description: 'Classic instant noodles',                       price: 30,  image_url: 'https://images.unsplash.com/photo-1612929633738-8fe44f7ec841?auto=format&fit=crop&w=400', category: 'Snack',    is_available: true, prep_time: '7m'  },
  { id: `${HIM_CANTEEN}_thali`,     outlet_id: HIM_CANTEEN,  name: 'Veg Thali',        description: 'Full veg thali with rice, dal, sabzi',          price: 70,  image_url: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&w=400',  category: 'Main',     is_available: true, prep_time: '15m' },
  { id: `${HIM_CANTEEN}_roti`,      outlet_id: HIM_CANTEEN,  name: 'Roti + Sabzi',     description: '3 rotis with seasonal sabzi',                   price: 40,  image_url: 'https://images.unsplash.com/photo-1565557623262-b51c2513a641?auto=format&fit=crop&w=400', category: 'Main',     is_available: true, prep_time: '10m' },
  { id: `${HIM_JUICE}_mango`,       outlet_id: HIM_JUICE,    name: 'Mango Shake',      description: 'Fresh mango milkshake',                         price: 50,  image_url: 'https://images.unsplash.com/photo-1600271886742-f049cd451bba?auto=format&fit=crop&w=400',  category: 'Juice',    is_available: true, prep_time: '5m'  },
  { id: `${HIM_JUICE}_sugarcane`,   outlet_id: HIM_JUICE,    name: 'Sugarcane Juice',  description: 'Fresh pressed sugarcane',                       price: 30,  image_url: 'https://images.unsplash.com/photo-1556679343-c7306c1976bc?auto=format&fit=crop&w=400',  category: 'Juice',    is_available: true, prep_time: '3m'  },
  { id: `${KG_CANTEEN}_meals`,      outlet_id: KG_CANTEEN,   name: 'Full Meals',       description: 'Rice, sambar, rasam, papad, pickle',            price: 65,  image_url: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&w=400',  category: 'Main',     is_available: true, prep_time: '10m' },
  { id: `${KG_CANTEEN}_curd_rice`,  outlet_id: KG_CANTEEN,   name: 'Curd Rice',        description: 'Cooling curd rice with pickle',                 price: 40,  image_url: 'https://images.unsplash.com/photo-1603133872878-684f208fb84b?auto=format&fit=crop&w=400',  category: 'Main',     is_available: true, prep_time: '5m'  },
  { id: `${KG_SNACKS}_vada`,        outlet_id: KG_SNACKS,    name: 'Medu Vada',        description: 'Crispy vada with sambar',                       price: 20,  image_url: 'https://images.unsplash.com/photo-1601050690597-df0568f70950?auto=format&fit=crop&w=400', category: 'Snack',    is_available: true, prep_time: '5m'  },
  { id: `${KG_SNACKS}_chai`,        outlet_id: KG_SNACKS,    name: 'Chai',             description: 'Hot tea',                                       price: 10,  image_url: 'https://images.unsplash.com/photo-1556679343-c7306c1976bc?auto=format&fit=crop&w=400',  category: 'Beverage', is_available: true, prep_time: '3m'  },
